...
private:
    ...
    rev::CANSparkMax m_shooterPrimary{7, rev::CANSparkMaxLowLevel::MotorType::kBrushless};
    rev::CANSparkMax m_shooterFollower{8, rev::CANSparkMaxLowLevel::MotorType::kBrushless};
